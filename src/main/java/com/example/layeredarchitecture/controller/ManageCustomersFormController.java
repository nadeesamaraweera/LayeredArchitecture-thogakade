...
import com.example.layeredarchitecture.dao.QuaryDAO;
...
import com.example.layeredarchitecture.dao.custom.QuaryDAOImpl;
...
public class ManageCustomersFormController {
   ...
   // QuaryDAOImpl quaryDAO = new QuaryDAOImpl();
    ...
    private String generateNewId() {
        try {
           String rst=customerBO.genarateId();
   ...
   /* public QuaryDAOImpl getQuaryDAO(){
        return quaryDAO;
    }*/
